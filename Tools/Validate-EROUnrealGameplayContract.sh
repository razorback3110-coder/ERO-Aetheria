...
grep -q 'SchemaVersion = 3' "$savegame"
grep -q 'PersistentPlayerId' "$savegame"
...
grep -q 'GetUniqueId' "$economy"
grep -q 'FCrc::StrCrc32' "$economy"
grep -q 'LegacySlotName' "$economy"
grep -q 'SchemaVersion >= 1 && SaveGame->SchemaVersion <= 2' "$economy"
grep -q 'SaveGame->PersistentPlayerId = SlotName' "$economy"
grep -q 'Migrated ERO economy save' "$economy"
