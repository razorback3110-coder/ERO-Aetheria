...
grep -q 'Aetheria_MVP_01' "$gamemode"
grep -q '250000.0f' "$gamemode"
grep -q '3600.0f' "$gamemode"
grep -q 'bIsMVP' "$gamemode"
grep -q 'MvpScale' "$gamemode"
grep -q 'bIsMVP' "$encounters"
grep -q 'GoldReward' "$encounters"
grep -q 'ItemRewardId' "$encounters"
