...
namespace ERO.Data
{
    ...
    [Serializable] public class EROStatAllocation
    {
        public int strength, agility, dexterity, intelligence, vitality, spirit, luck;
        public int Get(EROPrimaryStat stat) => stat switch { EROPrimaryStat.Strength => strength, EROPrimaryStat.Agility => agility, EROPrimaryStat.Dexterity => dexterity, EROPrimaryStat.Intelligence => intelligence, EROPrimaryStat.Vitality => vitality, EROPrimaryStat.Spirit => spirit, EROPrimaryStat.Luck => luck, _ => 0 };
        public void Add(EROPrimaryStat stat, int amount) { switch (stat) { case EROPrimaryStat.Strength: strength += amount; break; case EROPrimaryStat.Agility: agility += amount; break; case EROPrimaryStat.Dexterity: dexterity += amount; break; case EROPrimaryStat.Intelligence: intelligence += amount; break; case EROPrimaryStat.Vitality: vitality += amount; break; case EROPrimaryStat.Spirit: spirit += amount; break; case EROPrimaryStat.Luck: luck += amount; break; } }
