...
namespace ERO.Data
{
    ...
    {
        public int strength, agility, dexterity, intelligence, vitality, spirit, luck;
        public int Get(EROPrimaryStat stat) => stat switch
        {
            EROPrimaryStat.Strength => strength, EROPrimaryStat.Agility => agility, EROPrimaryStat.Dexterity => dexterity,
            EROPrimaryStat.Intelligence => intelligence, EROPrimaryStat.Vitality => vitality, EROPrimaryStat.Spirit => spirit,
            EROPrimaryStat.Luck => luck, _ => 0
        };
        public void Add(EROPrimaryStat stat, int amount)
        {
            switch (stat)
            {
                case EROPrimaryStat.Strength: strength += amount; break; case EROPrimaryStat.Agility: agility += amount; break;
                case EROPrimaryStat.Dexterity: dexterity += amount; break; case EROPrimaryStat.Intelligence: intelligence += amount; break;
                case EROPrimaryStat.Vitality: vitality += amount; break; case EROPrimaryStat.Spirit: spirit += amount; break;
    ...
    [Serializable] public class EROGemData { public string id; public string name; public Rarity rarity; public EROGemColor color; public EROPrimaryStat stat; public int statValue; public int level = 1; }
    [Serializable] public class ERORuneData { public string id; public string name; public Rarity rarity; public ERORuneType type; public ERORuneTrigger trigger = ERORuneTrigger.Passive; public EROPrimaryStat stat; public int statValue; public int powerBasisPoints; public EROClass requiredClass; public int requiredLevel; public string setId; }
    [Serializable] public class EROEquipmentSocket { public bool unlocked; public bool runeSocket; public string gemId; public string runeId; }
    [Serializable] public class EROTranscendenceData { public int level; public int maxLevel = 20; public bool protectedFromDestruction; }
    ...
    {
        public string id; public string name; public Rarity rarity; public int level; public int quantity = 1; public bool equipped;
        public string setId; public EROElement element = EROElement.Arcane; public EROTranscendenceData transcendence = new EROTranscendenceData();
