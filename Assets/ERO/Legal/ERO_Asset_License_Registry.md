...
| `EROCombatResolver.cs` | ERO-Aetheria source code | ERO-owned/original | Yes | Not required | Unity-free authoritative basic-attack and skill-damage resolution with server-supplied deterministic critical rolls and overflow-safe damage scaling |
